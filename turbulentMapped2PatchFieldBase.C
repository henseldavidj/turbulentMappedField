...
#include "turbulentMapped2PatchFieldBase.H"
...
template<class Type>
turbulentMapped2PatchFieldBase<Type>::turbulentMapped2PatchFieldBase
(
...
turbulentMapped2PatchFieldBase<Type>::sampleField() const
{
...
template<class Type>
tmp<Field<Type> > turbulentMapped2PatchFieldBase<Type>::mappedField() const
{
    typedef GeometricField<Type, fvPatchField, volMesh> fieldType;
    ...
    switch (mapper_.mode())
    {
        ...
        case mappedPatchBase::NEARESTPATCHFACEAMI:
        {
            ...
            if (nbrPatchID < 0)
            {
                FatalErrorIn
                (
                    "void turbulentMapped2PatchFieldBase<Type>::updateCoeffs()"
        ...
        default:
        {
            FatalErrorIn
            (
                "turbulentMapped2PatchFieldBase<Type>::updateCoeffs()"
...
*/
        ...
        scalar meanVelocityWanted = 20;

        //TODO: Parameterize this
        scalar stdevGiven = 0.02 * meanVelocityWanted;  //"the free stream turbulence int he 
...
template<class Type>
void turbulentMapped2PatchFieldBase<Type>::write(Ostream& os) const
{
